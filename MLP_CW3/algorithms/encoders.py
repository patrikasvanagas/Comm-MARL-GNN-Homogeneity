...
class GATNetwork(nn.Module):  
    ...
    def forward(self, h):
        ...
        g_concat = g_concat.view(samples_nr, process_nr, agents_nr, agents_nr, self.n_heads, 2 * self.n_hidden)
        ...
        if self.is_concat:
            attn_res = attn_res.reshape(samples_nr, process_nr, agents_nr, self.n_heads * self.n_hidden)
        else:
